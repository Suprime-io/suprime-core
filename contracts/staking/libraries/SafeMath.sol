...
/**
 * COPIED FROM
 * https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v4.5/contracts/utils/math/SafeMath.sol
...
library SafeMath {
    ...
    /// @dev Returns the unchecked addition of two unsigned integers
    ...
    /**
     * @dev Performs an unchecked addition of two numbers.
     *
     * _Available since v3.4._
     */
    ...
    /// @dev Returns the unchecked substraction of two unsigned integers
    ...
    /// @dev Returns the unchecked division of two unsigned integers
